...
public class ProdutosDAO {
    ...
    //Listar produtos por nome (retorna uma lista)
...
//Retorna um produto por nome (retorna um objeto)  
    ...
    //Retorna um produto por código (retorna um objeto)  
    ...
    //Metodo que adiciona uma quantidade de produto no estoque
